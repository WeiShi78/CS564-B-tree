...
void createRelationSize(int size);
void intTests();
void testEmpty();
...
void test4()
{
	// Create a relation with tuples valued 0 and perform index tests 
	// on attributes of all three types (int, double, string),
	// which also means testing for an empty tree
	std::cout << "--------------------" << std::endl;
	std::cout << "self test for empty tree" << std::endl;
	createRelationSize(0);
	testNum = 4;
	indexTests();
	std::cout << "indexTests finished" << std::endl;
	fflush(stdout);
	deleteRelation();
}
...
void test5()
{
	// Create a relation with tuples valued 0 to and perform index tests 
	// on attributes of all three types (int, double, string),
	// which also means testing for an empty tree
	std::cout << "--------------------" << std::endl;
	std::cout << "self test for very large tree (this may take a while)" << std::endl;
	createRelationSize(300000);
	testNum = 5;
	indexTests();
	deleteRelation();
}
...
// -----------------------------------------------------------------------------
// createRelationForward with specified size
// -----------------------------------------------------------------------------
